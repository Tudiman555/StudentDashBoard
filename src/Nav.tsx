...
const Nav: React.FC<Props> = (props) => {
  ...
  const shadow = isMenuOpen ? "shadow-md": "";

  return (
    <>
      <div className={"relative z-50 flex items-center justify-between px-4 bg-white md:px-6 md:justify-start "+ shadow }>
        <a className="py-4 md:mr-6" href="#" >
          <svg
            className="w-10 h-10 md:w-51p md:h-51p"
        ...
        <button className="flex items-center justify-center w-11 h-11 md:hidden">
          <svg
            onClick={() => setMenuIsOpen((open) => !open)}
            className="w-6 h-6 fill-current text-grey-500"
            viewBox="0 0 24 24"
          >
          ...
          <div>
            <ul>
              <li className="inline-block">
                <Link linkText="MENU"></Link>
              </li>
              <li className="inline-block pl-6">
                <Link linkText="REWARDS"></Link>
              </li>
              <li className="inline-block pl-6">
                <Link linkText="GIFT CARDS"></Link>
              </li>
            </ul>
          </div>
          <div className="flex-grow-0 flex-shrink-0 ml-auto">
            <div className="ml-10">
              <a href="#" className="pr-2 mr-10 hover:text-primary-300">
                <svg
                  viewBox="0 0 24 24"
                  className="inline-block w-6 h-8 fill-current"
                >
                ...
                <span className="pl-2 text-sm font-semibold">Find a store</span>
              </a>
              <RoundedLink
                linkUrl="#"
                linkName="Sign in"
      ...
      <Dialog open={isMenuOpen} onClose={setMenuIsOpen}>
          <Transition.Child
            as={Fragment}
          ...
          >
            <div className="fixed top-0 bottom-0 right-0 z-20 w-4/5 pt-20 ease-in-out bg-white">
